...
//Must be placed beneath the dotenv config because we will be using a environment variable in the below
mongoose.connect(process.env.MONGODB);

const db = mongoose.connection;

// bind is a mongoose method
...
const cors = (req, res, next) => {
    ...
    // The "*" allows all, better way is to specify the specific netlify or render.com address
...
// process the body first, so that we can possibly use it in our logging mechanism
app.use(cors);
